...
public class DamageUpgrade : MonoBehaviour, IBuildUpgrade
{
    public GameObject descriptionUiPrefab;
    private GameObject descriptionUiInstance;

    public GameObject damageBufferPrefab;
    public int cost;
    ...
    public void buildBuilding() {
        Instantiate(damageBufferPrefab, transform.position, transform.localRotation);
        Destroy(gameObject);
    }
